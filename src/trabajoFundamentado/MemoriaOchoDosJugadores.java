...
public class MemoriaOchoDosJugadores  extends JFrame implements ActionListener{
	JButton arreglo [] = new JButton[64];
	Carta cartas [] = new Carta [64];
	...
	public MemoriaOchoDosJugadores() {
		inciarTablero();
	}
	public final void inciarTablero() {
		...
		for(int ii = 0; ii <8; ii++) {
			for (int jj = 0; jj< 8; jj++) {
				...
				btn.setBounds((ii+1)*60,(jj+1)*80,65, 88);
	...
	public void revolver(){
		...
		int llenar = 0;
		Carta cartaTemporal [] = new Carta[64];
