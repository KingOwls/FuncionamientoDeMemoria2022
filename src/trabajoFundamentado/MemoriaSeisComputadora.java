...
public class MemoriaSeisComputadora  extends JFrame implements ActionListener{
	...
	public static String pedirNombre1() {
		String nom1 = JOptionPane.showInputDialog("Nombre de usuario ");
